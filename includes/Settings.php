...
class Settings {
	...
	public function register_menu() {
		add_submenu_page(
			'woocommerce',
			__( 'Dual Pricing Shipping', 'wcdps' ),
			__( 'Dual Pricing Shipping', 'wcdps' ),
			'manage_woocommerce',
			'wcdps-settings',
	...
	public static function get_default_settings() {
		return array(
			...
			'methods'   => array(
				'method_one'   => array(
					'enabled'    => 1,
					'title'      => __( 'Shipping Method One', 'wcdps' ),
					'below_cost' => 15000,
					'above_cost' => 0,
					'address'    => '',
					'phone'      => '',
				...
				'method_two'   => array(
					'enabled'    => 1,
					'title'      => __( 'Shipping Method Two', 'wcdps' ),
					'below_cost' => 19000,
					'above_cost' => 15000,
					'address'    => '',
					'phone'      => '',
				...
				'method_three' => array(
					'enabled'    => 1,
					'title'      => __( 'Shipping Method Three', 'wcdps' ),
					'below_cost' => 25000,
					'above_cost' => 0,
					'address'    => '',
					'phone'      => '',
	...
	public function render_page() {
		...
		<div class="wrap wcdps-wrap">
			<h1><?php echo esc_html__( 'Dual Pricing Shipping', 'wcdps' ); ?></h1>
			<p class="description">
				<?php echo esc_html__( 'Configure thresholds, rates, and pickup details for WooCommerce shipping.', 'wcdps' ); ?>
			</p>
			<form method="post" action="options.php">
				<?php settings_fields( 'wcdps_settings_group' ); ?>
				<div class="wcdps-grid">
					<div class="wcdps-card">
						<h2><?php echo esc_html__( 'Global Threshold', 'wcdps' ); ?></h2>
						<p><?php echo esc_html__( 'Subtotal threshold that switches to the upper pricing tier.', 'wcdps' ); ?></p>
						<label for="wcdps-threshold"><?php echo esc_html__( 'Threshold amount', 'wcdps' ); ?></label>
						<input
							id="wcdps-threshold"
							type="number"
							min="0"
						...
						<div class="wcdps-card">
							...
							<div class="wcdps-toggle">
								<label>
									...
									<span><?php echo esc_html__( 'Enabled', 'wcdps' ); ?></span>
								</label>
							</div>
							<label><?php echo esc_html__( 'Display title', 'wcdps' ); ?></label>
							...
							<div class="wcdps-split">
								<div>
									<label><?php echo esc_html__( 'Below threshold cost', 'wcdps' ); ?></label>
								...
								<div>
									<label><?php echo esc_html__( 'Above threshold cost', 'wcdps' ); ?></label>
					...
					<div class="wcdps-card wcdps-card-wide">
						<h2><?php echo esc_html__( 'Office Pickup', 'wcdps' ); ?></h2>
						<div class="wcdps-toggle">
							<label>
				...
				<div class="wcdps-actions">
					<?php submit_button( __( 'Save settings', 'wcdps' ), 'primary', 'submit', false ); ?>
				</div>
			</form>

			<div class="wcdps-card wcdps-card-wide wcdps-preview">
				<h2><?php echo esc_html__( 'Live Rate Preview', 'wcdps' ); ?></h2>
				<p><?php echo esc_html__( 'Test rates instantly without leaving the page.', 'wcdps' ); ?></p>
				<div class="wcdps-preview-controls">
					<label for="wcdps-preview-subtotal"><?php echo esc_html__( 'Subtotal amount', 'wcdps' ); ?></label>
					...
					<button class="button button-secondary" id="wcdps-preview-button" type="button">
						<?php echo esc_html__( 'Preview rates', 'wcdps' ); ?>
					</button>
				</div>
